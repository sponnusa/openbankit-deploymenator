var Env = {
	...
	G_AGENT_KEY: 'GBZSRJ7BMM7ZKRARSO3AMYAYWLRLUCBXIGQ2MQKWK65ESWORA7YDMJRE',
    KEYSERVER_HOST: 'http://keys.euah.pw',
    HORIZON_HOST: 'http://blockchain.euah.pw',
    EMISSION_HOST: 'http://emission.euah.pw',
	RIAK_HOST: 'de.euah.pw',
    API_HOST: 'http://api.euah.pw',
    INFO_HOST: 'http://info.euah.pw',
    EXCHANGE_HOST: 'http://exchange.euah.pw',
    SMARTMONEY_HOST: 'http://smartmoney.com.ua',
